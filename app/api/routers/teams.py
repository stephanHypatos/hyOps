...
# Note: User/UserTeamsGroup are used in /user/{user_id}/add and /user/{user_id}/remove
...
async def create_teams_team_for_org(org_id: UUID, session: SessionDep):
    ...
    - Does NOT auto-provision org users — add them manually via POST /teams/user/{id}/add.
    """
